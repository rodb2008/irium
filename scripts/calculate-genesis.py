...
def create_genesis_block():
    ...
    difficulty_target = 0x1d00ffff  # Initial difficulty (similar to Bitcoin)
    nonce = 0
    
    # Calculate genesis hash with proof-of-work
    genesis_hash = None
    target_nonce = None
    ...
    for n in range(0, 0xFFFFFFFF):
        ...
        if n % 100000 == 0:
            print(f"Tried nonce: {n}")
    
    if genesis_hash is None:
        print("Failed to find valid nonce, using placeholder")
