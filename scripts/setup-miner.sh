...
chmod 600 "$MINER_DIR/irium-wallet.json"
...
echo "   python3 scripts/irium-miner-individual.py --wallet $MINER_DIR/irium-wallet.json --bootstrap \"\$(awk -F= '/BOOTSTRAP_NODES/ {print \$2}' \"$MINER_DIR/miner.conf\")\""
