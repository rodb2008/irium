...
Version  Network  Status  License

🚨 Latest Release: v1.0 - Production Release - Stable blockchain with fixed mining and P2P sync. See Release Notes
...
✅ Coinbase Maturity Enforcement: Mining rewards locked for 100 blocks
✅ Timestamp Validation: Blocks validated within 2-hour consensus window
✅ Signature Verification: All transactions cryptographically verified
✅ UTXO Height Tracking: Enhanced validation with maturity checks

Critical Bug Fixes
Fixed nonce overflow in miners (4.29B limit)
Fixed P2P memory leak
Improved graceful shutdown
Enhanced error handling
⚠️ Important: v1.0 is a hard fork. All nodes must upgrade.
...
MINING.md - Complete mining guide
WALLET.md - Wallet management guide
...
Mining Process
Miner creates block template with pending transactions
Adds coinbase transaction (block reward + fees)
Calculates merkle root of all transactions
Iterates nonce to find hash < difficulty target
Broadcasts valid block to network
Other nodes validate and accept block
Miner earns reward (50 IRM currently)
...
Load existing blocks from ~/.irium/blocks/
Connect to seed peers
Compare heights with connected peers
Request missing blocks if peers are ahead
