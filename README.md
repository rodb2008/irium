...
> **🚨 Latest Release: v1.0** - Production Release - Stable blockchain with fixed mining and P2P sync. [See Release Notes](https://github.com/iriumlabs/irium/releases/tag/v1.0)
