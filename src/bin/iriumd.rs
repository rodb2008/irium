...
use irium_node_rs::tx::{
    ...
    parse_htlc_btc_swap_v1_script, parse_htlcv1_script, parse_output_encumbrance,
    HtlcBtcSwapV1Output, HtlcV1Output, OutputEncumbrance, Transaction, TxInput, TxOutput,
