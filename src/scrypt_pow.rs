...
mod tests {
    ...
    fn scrypt_hash_is_deterministic() {
        ...
        assert_eq!(
            a, b,
            "scrypt must produce identical output for identical input"
        );
    }
    ...
    fn scrypt_hash_matches_litecoin_core_reference() {
        ...
        const HEADER: [u8; 80] = [
            0x00, 0x00, 0x00, 0x20, 0x1a, 0xdc, 0xe3, 0x6e, 0x7b, 0xa5, 0x0d, 0x2f, 0x99, 0x1e,
            0x30, 0xa7, 0xfb, 0xf5, 0xe0, 0x77, 0x45, 0x65, 0x9f, 0xa8, 0x73, 0x21, 0x72, 0xee,
            0xae, 0xba, 0xad, 0x02, 0x9b, 0xf0, 0x25, 0xd0, 0xe6, 0x40, 0x2a, 0xb7, 0xa6, 0x1d,
            0xfc, 0x13, 0xa1, 0x4a, 0xd0, 0x7e, 0x0b, 0xe2, 0xe3, 0x23, 0x7a, 0xec, 0x7e, 0x7e,
            0x86, 0x4d, 0x42, 0xaa, 0x32, 0xb6, 0x4c, 0xc0, 0x55, 0x8a, 0xee, 0x9f, 0xa9, 0x73,
            0x04, 0x6a, 0x19, 0xb6, 0x29, 0x19, 0x49, 0x26, 0x83, 0x85,
        ];
        ...
        const EXPECTED: [u8; 32] = [
            0xdf, 0xab, 0x61, 0x0c, 0x22, 0x16, 0x45, 0xe7, 0xf4, 0x8b, 0x27, 0xb5, 0x3b, 0xce,
            0x33, 0x73, 0x13, 0xf1, 0x34, 0xa9, 0xf0, 0xc5, 0x61, 0x9b, 0x29, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00,
        ];
