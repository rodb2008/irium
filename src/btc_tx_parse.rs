...
pub enum BtcOutputScript {
    ...
    OpReturn(Vec<u8>),
    /// Anything else: P2WPKH, P2WSH, P2TR, P2SH, multisig, non-standard, etc.
    Other,
}
...
mod tests {
    ...
    #[test]
    fn parse_recognises_p2wpkh_as_other() {
        // P2WPKH script: OP_0 <0x14> <20 bytes>, total 22 bytes — not P2PKH, not OP_RETURN.
